	...
	<div class="row">
		<div class="col-sm-3 col-md-2 sidebar">
			<ul class="nav nav-sidebar">
				<li ><a href="query">Promotion Code Management</a></li>
				<li class="active"><a href="dispadd">New Promotion Code</a></li>
			</ul>
		</div>
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<form class="form-horizontal" id="newProCodeForm" name="newProCodeForm">
				<fieldset>
					...
					<!-- Form Name -->
					<legend>Generate a new promotion code</legend>
					...
					<div class="form-group">
					  ...
					  <div class="col-md-4"> 
					    <label class="radio-inline" for="radios-0">
					      <input type="radio" name="np_type" id="np_type_percent" value="1" checked="checked">
					      By Percentage
					    </label> 
					...
					<div class="form-group" id="percentDiv">
						...
						<div class="col-md-4">
							<input id="np_percent" name="np_percent" type="text"
					...
					<div class="form-group" id="amountDiv" >
						<label class="col-md-4 control-label" for="textinput">Amount</label>
						<div class="col-md-2">
							<input id="np_lower" name="np_lower" type="text"
								placeholder="lower amount" class="form-control input-md"> 
						</div>
						<div class="col-sm-1" align="center">
							<span>to</span> 
						</div>
						<div class="col-md-2">
							<input id="np_upper" name="np_upper" type="text"
								placeholder="upper amount" class="form-control input-md"> 
						</div>
					</div>
					...
					<div class="form-group">
					  ...
					  <div class="col-md-4">                     
					    <textarea class="form-control" id="np_notes" name="np_notes"></textarea>
					  </div>
					</div>
