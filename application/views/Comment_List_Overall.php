	...
	<div class="row">
		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<form role="form" class="form-inline"
				action="Comment_List_Overall.php" method="GET">
				...
				<div class="form-group col-sm-offset-1">
					<label for="exampleInputEmail1">End Time:</label> <input
						...
						placeholder="Select end time" value="<?php echo $enddate?>">
				</div>
				&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<tbody>
							 ...
							 <?php
								for($i = 0; $i < count ( $items ); $i ++) {
									...
									?>
	   						    <tr>
									<td> <?php echo  $row["overallcomment_date"];?>  </td>
									<td>  <?php echo  $row["overallcomment_content"];?>  </td>
								</tr>
...
<script src="<?php echo base_url() ?>public/js/Comment_List_Overall.js"></script>
